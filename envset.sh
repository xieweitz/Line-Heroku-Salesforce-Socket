#!/bin/sh
#アクセストークン設定
heroku config:set LINE_CHANNEL_ACCESS_TOKEN=q9xwOo3sXk+8o0wOv3iiuLoEfnAhTGfIkltvlXyYwU/e3umF9uJuGGzhEB004RXks2ydbcW2xNDS9xLXWMcwowoXbP5mGDtE2ndKF2jv70qo0bEXypHgpn0a2Sx0BcCrLkf53EaEeBUJFrUaWogBWQdB04t89/1O/w1cDnyilFU= -a line-heroku-salesforce-socket
#チャネル設定
...
#アクセストークン設定
#heroku config:set LINE_CHANNEL_ACCESS_TOKEN=/PytQxc7HdBUt3d/Te/1piF80yQTSs9Tg0253pcgw2fh9Xv16cx50YMS5lhX8DskUQ29ktnx97yf2EnIC7ZYpe2jBmapSuyYfkYxnycqhwWZ2IlYLMC+382410fSk2LlTtZhWz8olNs8cMeepOKHWQdB04t89/1O/w1cDnyilFU= -a line-heroku-salesforce-socket
#チャネル設定
